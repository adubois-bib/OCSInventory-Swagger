...
public class ComputersListComputerId   {
  private List<ComputersListComputerIdAccountinfo> accountinfo = new ArrayList<ComputersListComputerIdAccountinfo>();
  private List<String> batteries = new ArrayList<String>();
