...
public interface IpdiscoverApi  {
    ...
    Response ipdiscoverGet( @QueryParam("start") Integer start, @QueryParam("limit") Integer limit,@Context SecurityContext securityContext);
    ...
    Response ipdiscoverNetworkNetidGet( @PathParam("netid") Integer netid,@Context SecurityContext securityContext);
