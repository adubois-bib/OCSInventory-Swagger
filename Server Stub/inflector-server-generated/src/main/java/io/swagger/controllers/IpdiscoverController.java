...
public class IpdiscoverController  {
  /** 
  ...
  /*
    public ResponseContext ipdiscoverGET(RequestContext request , Integer start 
, Integer limit 
) {
  ...
  */
  ...
  /*
    public ResponseContext ipdiscoverNetworkNetidGET(RequestContext request , Integer netid 
) {
        return new ResponseContext().status(Status.INTERNAL_SERVER_ERROR).entity( "Not implemented" );
    }
  */
