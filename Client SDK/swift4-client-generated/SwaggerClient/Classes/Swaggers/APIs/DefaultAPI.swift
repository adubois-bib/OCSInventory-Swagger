...
open class DefaultAPI {
  ...
  "{computer_id}" : {
    ...
    /**
     ...
     - parameter _id: (path) ID of the computer in OCS database      - parameter sections: (path) Name of the requested section (i.e -&gt; bios, software, etc..)      - parameter _where: (query) Search on a specific column of the specific section. (optional)     - parameter _operator: (query) Search operator (like, not like, &#x3D;, !&#x3D;, &lt;, &gt;, &lt;&#x3D;, &gt;&#x3D;). Mandatory if where parameter is set. (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
  ...
  "{computer_id}" : {
    ...
    /**
     ...
     - parameter start: (query) Start offset of the query (optional)     - parameter limit: (query) Limit offset of the query (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
  ...
  "NAME" : "-"
    ...
    /**
     ...
     - parameter snmpType: (path) Name of the snmp type you want to list      - parameter start: (query) Start offset of the query (optional)     - parameter limit: (query) Limit offset of the query (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
  ...
  "DefaultLocation" : "Here"
    ...
    /**
     ...
     - parameter snmpType: (path) Name of the snmp type you want to list      - parameter _id: (path) Identifiant en base de données de l&#x27;équipement 
     - parameter completion: completion handler to receive the data and the error objects
     */
  ...
  "TYPE_NAME" : "Default"
    ...
    /**
     ...
     - parameter start: (query) Start offset of the query (optional)     - parameter limit: (query) Limit offset of the query (optional)     - parameter soft: (query) Name of the software you want to search (optional) (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
